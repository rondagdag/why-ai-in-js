...
import { A as APP_CONSTANTS, g as getGenerationByLevel, a as generations, l as levelNames } from "./app.js";
...
function Select({ options, value, onValueChange, placeholder = "Select...", className }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: selectRef, className: cn("relative", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: selectedOption ? selectedOption.label : placeholder }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: cn("h-4 w-4 opacity-50 transition-transform", isOpen && "rotate-180") })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full left-0 z-50 mt-1 w-full rounded-md border bg-popover shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-60 overflow-auto p-1", children: options.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        className: cn(
        ...
        children: [
          ...
          option.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: option.description })
        ]
      },
      option.value
    )) }) })
...
function App() {
  ...
  const handleRerun = reactExports.useCallback(() => {
    if (selectedText) {
  ...
  const messageListener = reactExports.useCallback((message, _sender, sendResponse) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "container mx-auto p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "Explain in Generations" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", htmlFor: "generation-select", children: "Generation:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Select,
          {
      ...
      selectedText && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          onClick: handleRerun,
          disabled: loading,
          ...
          children: [
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "mr-2 h-4 w-4" }),
            "Rerun with ",
            getGenerationByLevel(currentLevel)?.name
          ]
        }
      )
    ] }),
    loading && total > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border p-4 prose dark:prose-invert max-w-none", children: summary || loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-3 py-1 rounded-full text-sm bg-primary/10 text-primary border border-primary/20", children: levelNames[currentLevel] }) }),
